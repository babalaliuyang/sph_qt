<template>
  <div class="cart">
        ...
        <ul class="cart-list" v-for="item in list" :key="item.id">
          <li class="cart-list-con1">
            <input
              ...
              @change="updataChecked(item.skuId, item.isChecked)"
            />
          </li>
          ...
          <li class="cart-list-con5">
            <a
              ...
              class="mins"
              @click="handler(-1, item.skuId, item.skuNum)"
              >-</a
            >
            <input
              autocomplete="off"
              ...
              minnum="1"
              class="itxt"
              @change="handler(item.isChecked, item.skuId, item.skuNum)"
            />
            <a
              href="javascript:void(0)"
              class="plus"
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a @click="deleteIsChecked">删除选中的商品</a>
...
export default {
  ...
  methods: {
    ...
    async updataChecked(skuId, Checked) {
      try {
